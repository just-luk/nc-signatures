...
constexpr char binary8_neon::name[];

finite_field binary8_neon::field() const
{
    return fifi::finite_field::binary8;
}

binary8 binary8_neon::field_info() const
{
    return m_field;
}
...
std::size_t binary8_neon::vector_multiply_add_into(uint8_t* x, const uint8_t* y,
                                                   uint32_t constant,
...
std::size_t binary8_neon::vector_multiply_into(uint8_t* x, uint32_t constant,
                                               std::size_t size) const
{
    assert(x != nullptr);
    assert(size > 0U);
...
std::size_t binary8_neon::vector_dot_product(uint8_t** x, const uint8_t** y,
...
std::size_t binary8_neon::vector_multiply_add_into(uint8_t*, const uint8_t*,
...
std::size_t binary8_neon::vector_multiply_into(uint8_t*, uint32_t,
                                               std::size_t) const
{
    assert(0 && "Target platform or compiler does not support this "
                "implementation");
...
std::size_t binary8_neon::vector_dot_product(uint8_t**, const uint8_t**,
