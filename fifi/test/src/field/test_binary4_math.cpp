...
static constexpr fifi::field::binary4_backend backend(0x13);

TEST(test_binary4_math, add)
{
    fifi::field::binary4_math math{&backend};
...
TEST(test_binary4_math, subtract)
{
    fifi::field::binary4_math math{&backend};
...
TEST(test_binary4_math, multiply)
{
    fifi::field::binary4_math math{&backend};
...
TEST(test_binary4_math, vector_add_into)
{
    fifi::field::binary4_math math{&backend};
...
TEST(test_binary4_math, vector_subtract_into)
{
    fifi::field::binary4_math math{&backend};
...
TEST(test_binary4_math, vector_multiply_into)
{
    fifi::field::binary4_math math{&backend};

    auto size = helper::random_vector_size(1U);
    helper::test_vector_multiply_into(math, size,
                                      rand() % fifi::field::binary4::order);

    auto expected_size = math.total_processed();
    EXPECT_EQ(expected_size, size);
}

TEST(test_binary4_math, vector_multiply_add_into)
{
    fifi::field::binary4_math math{&backend};
...
TEST(test_binary4_math, vector_multiply_subtract_into)
{
    fifi::field::binary4_math math{&backend};
...
TEST(test_binary4_math, vector_dot_product)
{
    fifi::field::binary4_math math{&backend};
...
TEST(test_binary4_math, field)
{
    fifi::field::binary4_math math{&backend};
    EXPECT_EQ(0x13U, math.field_info().prime());
}
