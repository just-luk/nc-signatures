...
static constexpr fifi::field::binary16_backend backend(0x1100B);

TEST(test_binary16_math, add)
{
    fifi::field::binary16_math math{&backend};
...
TEST(test_binary16_math, subtract)
{
    fifi::field::binary16_math math{&backend};
...
TEST(test_binary16_math, multiply)
{
    fifi::field::binary16_math math{&backend};
...
TEST(test_binary16_math, divide)
{
    fifi::field::binary16_math math{&backend};
...
TEST(test_binary16_math, invert)
{
    fifi::field::binary16_math math{&backend};
...
TEST(test_binary16_math, vector_add_into)
{
    fifi::field::binary16_math math{&backend};

    auto size = helper::random_vector_size(2U);
...
TEST(test_binary16_math, vector_subtract_into)
{
    fifi::field::binary16_math math{&backend};
...
TEST(test_binary16_math, vector_multiply_into)
{
    fifi::field::binary16_math math{&backend};

    auto size = helper::random_vector_size(2U);
    helper::test_vector_multiply_into(math, size,
                                      rand() % fifi::field::binary16::order);

    auto expected_size = math.total_processed();
    EXPECT_EQ(expected_size, size);
}

TEST(test_binary16_math, vector_multiply_add_into)
{
    fifi::field::binary16_math math{&backend};
...
TEST(test_binary16_math, vector_multiply_subtract_into)
{
    fifi::field::binary16_math math{&backend};
...
TEST(test_binary16_math, vector_dot_product)
{
    fifi::field::binary16_math math{&backend};
...
TEST(test_binary16_math, field)
{
    fifi::field::binary16_math math{&backend};
    EXPECT_EQ(0x1100BU, math.field_info().prime());
}
