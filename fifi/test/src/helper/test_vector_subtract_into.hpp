...
namespace helper
{
// Test helper calculating the vector subtract. First using the provided
...
template <class Math>
inline void test_vector_subtract_into(const Math& math, std::size_t size)
{
    ...
    math.vector_subtract_into(x.data(), y.data(), size);
    ...
    for (std::size_t i = 0; i < elements; ++i)
    {
        ...
        EXPECT_EQ(fifi::online::subtract(field, value_x0, value_y), value_x);
    }
}
}
