...
namespace field
{
/// Implements SSSE3 SIMD-accelerated finite field arithmetics for binary8.
...
public:
    ...
    static constexpr char name[] = "binary8_ssse3";

public:
#ifdef FIFI_PLATFORM_X86
    /// Constructor
    constexpr binary8_ssse3(binary8 field) noexcept :
...
#else
    /// Constructor
    constexpr binary8_ssse3(binary8 field) noexcept : m_field(field)
    {
    }
#endif
