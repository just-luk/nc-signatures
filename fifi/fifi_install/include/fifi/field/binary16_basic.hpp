...
/// Finite field computations in binary16 using standard lookup tables to
/// accelerate computations. This implementation is platform / CPU architecture
/// independent.
class binary16_basic
{
public:
    ...
    static constexpr char name[] = "binary16_basic";

public:
    /// Construcor
    constexpr binary16_basic(binary16 field) noexcept : m_table(field)
    {
    }
...
private:
    /// Log table used for the computations
    detail::log_table<binary16> m_table;
};
