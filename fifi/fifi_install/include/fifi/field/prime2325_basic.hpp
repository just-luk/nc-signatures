...
/// Finite field computations in 2³²-5. This implementation is platform / CPU
/// architecture independent.
class prime2325_basic
{
public:
    ...
    static constexpr char name[] = "prime2325_basic";
...
public:
    ...
    /// @copydoc acceleration::vector_subtract_into()
