...
namespace field
{
/// Finite field computations in the binary field with SSE2
/// acceleration.
class binary_sse2
{
public:
    /// The SIMD instruction set required
    static constexpr simd simd_type = simd::sse2;

    /// The name of this acceleration
    static constexpr char name[] = "binary_sse2";

public:
    /// Constructor
    constexpr binary_sse2() = default;
