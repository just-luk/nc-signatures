...
/// Finite field operations in the binary extension field 2^4.
class binary4_math
{
public:
    /// The backend used
    using backend_type = binary4_backend;

    /// The finite field
    using field_type = binary4;
...
public:
    ...
    /// Constructor
    binary4_math(const binary4_backend* backend);
    ...
    void set_backend(const binary4_backend* backend);
    void set_backend(const binary4_backend* backend,
                     const detail::cpu_support& cpu);
...
private:
    ...
    const binary4_backend* m_backend;
    ...
    detail::enabled_ptr<binary4_basic> m_binary4_basic;

    /// Binary4 AVX2 acceleration
    detail::enabled_ptr<binary4_ssse3> m_binary4_ssse3;

    /// Binary4 AVX2 acceleration
    detail::enabled_ptr<binary4_avx2> m_binary4_avx2;

    /// Binary4 NEON acceleration
    detail::enabled_ptr<binary4_neon> m_binary4_neon;
