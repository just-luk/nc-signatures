...
/// Implements NEON SIMD accelerated finite field arithmetics for binary4.
class binary4_neon
{
public:
    ...
    static constexpr char name[] = "binary4_neon";

public:
#ifdef FIFI_PLATFORM_ARM
    /// Constructor
    constexpr binary4_neon(binary4 field) noexcept :
...
#else
    /// Constructor
    constexpr binary4_neon(binary4 field) noexcept : m_field(field)
    {
    }
#endif
