...
void generate_coded_symbols(kodo::fulcrum::encoder& encoder,
...
void generate_systematic_symbols(kodo::fulcrum::encoder& encoder,
...
static void fulcrum_encode_coded(benchmark::State& state,
                                 ...
                                 std::size_t expansion)
{
    ...
    state.counters["expansion"] = expansion;
...
static void fulcrum_encode_systematic(benchmark::State& state,
                                      std::size_t symbols,
                                      std::size_t symbol_bytes,
                                      std::size_t expansion)
{
    ...
    std::vector<std::vector<uint8_t>> systematic_symbols(
        ...
        std::vector<uint8_t>(encoder.symbol_bytes(), 0));
...
static void fulcrum_decode_coded(benchmark::State& state,
                                 kodo::finite_field field, std::size_t symbols,
                                 std::size_t symbol_bytes,
                                 std::size_t expansion)
{
...
static void fulcrum_decode_systematic(benchmark::State& state,
                                      std::size_t symbols,
                                      std::size_t symbol_bytes,
                                      std::size_t expansion)
{
...
BENCHMARK_CAPTURE(fulcrum_encode_systematic, systematic, 200, 1400, 20)
    ->Apply(BenchmarkArguments);

BENCHMARK_CAPTURE(fulcrum_decode_systematic, systematic, 200, 1400, 20)
    ->Apply(BenchmarkArguments);

BENCHMARK_CAPTURE(fulcrum_encode_coded, binary, kodo::finite_field::binary, 200,
                  1400, 20)
    ->Apply(BenchmarkArguments);
BENCHMARK_CAPTURE(fulcrum_encode_coded, binary4, kodo::finite_field::binary4,
                  200, 1400, 20)
    ->Apply(BenchmarkArguments);
BENCHMARK_CAPTURE(fulcrum_encode_coded, binary8, kodo::finite_field::binary8,
                  200, 1400, 20)
    ->Apply(BenchmarkArguments);

BENCHMARK_CAPTURE(fulcrum_decode_coded, binary, kodo::finite_field::binary, 200,
                  1400, 20)
    ->Apply(BenchmarkArguments);
BENCHMARK_CAPTURE(fulcrum_decode_coded, binary4, kodo::finite_field::binary4,
                  200, 1400, 20)
    ->Apply(BenchmarkArguments);
BENCHMARK_CAPTURE(fulcrum_decode_coded, binary8, kodo::finite_field::binary8,
                  200, 1400, 20)
    ->Apply(BenchmarkArguments);
