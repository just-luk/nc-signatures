...
/// @example parity_2d/encode_decode_simple.cpp
///
/// Simple example showing how to encode and decode a block
/// of memory using the parity 2d code.
int main()
{
    ...
    auto field = kodo::finite_field::binary;
