...
using stack_encoder =
    layer_reset<
    // Encoder API
    fulcrum::layer_encoding_algorithm<
    fulcrum::layer_coefficients_storage<
    fulcrum::layer_encoders<Math,
    // Symbol Storage API
    fulcrum::layer_expansion_symbols<
